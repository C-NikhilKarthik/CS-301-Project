      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col py-2 gap-1">
          ...
          <Link to="/login" className="flex justify-center">
            <button
              type="button"
              className="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center justify-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 "
            >
              Sign Up
              <svg
                aria-hidden="true"
